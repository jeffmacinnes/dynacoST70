...
This build incorporates four well-known, widely-recommended modifications to the stock ST-70 design. Each is its own page, covering what changes, what it costs (in parts, time, and reversibility), and why it's worth doing.
