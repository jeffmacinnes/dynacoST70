...
Both pots' lug 1 terminals are now tied together at the bias supply's lug-3-strip voltage (also ~−65 V). Combined with [step 27](step-27-bias-pot-interconnect-1.md), both pots have **identical voltages at both ends of their resistance elements**.
...
- ✅ Bias diode rectifying 55 V AC → ~−65 V DC pulsing
